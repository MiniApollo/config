...
For more [[https://www.gnu.org/software/emacs/manual/html_mono/eglot.html][information how to use.]] One alternative to Eglot is Lsp-mode, check out [[https://github.com/MiniApollo/kickstart.emacs/wiki][kickstart.emacs wiki]] page for more information.
...
** Language modes
It's not required for every language like C,C++,C#,Java,Javascript etc. to download language mode packages, but for more specific languages it is necessary for syntax highlighting.
