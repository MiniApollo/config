...
#+begin_src emacs-lisp
    ...
    (defface fa-ts-string-face
      ...
      "Face for the object identifier in a selector expression."
      :group 'treesit-font-lock)

    (defface fa-ts-field-face
    ...
    (defvar fa/ts-font-lock-settings
      (treesit-font-lock-rules
       ...
       :override t ;; Override any default rule
       `(
    	 ;; Function calls
         (call_expression
