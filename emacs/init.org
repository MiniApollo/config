...
#+begin_src emacs-lisp
    ...
    (use-package general
      ...
      (general-create-definer start/leader-keys
        ...
        :keymaps 'override
        :prefix "SPC"
        :global-prefix "M-m") ;; Set global leader key so we can access our keybindings from any state
...
#+begin_src emacs-lisp
    (use-package eglot
      ...
      (flymake-show-diagnostics-at-end-of-line t) ;; Show sideline errors
      ;; Manual lsp servers
      :config
    ...
    (defun mark/setup-capfs ()
      ...
      (let ((merge-backends (list
        ...
        (when (bound-and-true-p git-commit-mode)
          ...
          (setq merge-backends (remq #'snippy-capf merge-backends))
          (setq merge-backends (remq #'yasnippet-capf merge-backends)))
