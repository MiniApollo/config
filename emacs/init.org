...
#+begin_src emacs-lisp
    ...
    (defun mark/get-work-dirs ()
      "Return list of work directories for consult.
            If called interactively, forces a refresh of the cache."
      (interactive)
    ...
    (use-package orderless
      ...
      (completion-category-overrides
       '((file (styles basic partial-completion))
         (directory (styles orderless-with-flex basic))))
      :config
      ;; Define a custom orderless style specifically for flex/typo tolerance
