...
#+begin_src emacs-lisp
    ...
    (use-package general
      ...
      ;; Harpoon
      (start/leader-keys
    	"a" '(harpoon-toggle-quick-menu :wk "Harpoon quick menu")
    	"h" '(harpoon-go-to-1 :wk "Harpoon go to 1")
    	"j" '(harpoon-go-to-2 :wk "Harpoon go to 2")
    	"k" '(harpoon-go-to-3 :wk "Harpoon go to 3")
    	"l" '(harpoon-go-to-4 :wk "Harpoon go to 4"))

      (start/leader-keys
    	"m" '(:ignore t :wk "Harpoon")
    	"m a" '(harpoon-add-file :wk "Harpoon add file")
    	"m f" '(harpoon-toggle-file :wk "Harpoon toggle file")
    	"m c" '(harpoon-clear :wk "Harpoon clear")
    	"m p" '(harpoon-go-to-prev :wk "Harpoon previous")
