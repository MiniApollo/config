...
#+begin_src emacs-lisp
    ...
    (use-package evil-collection
      ...
      (setq evil-collection-mode-list '(dired ibuffer magit corfu consult info vterm vundo (package-menu package)))
...
#+begin_src emacs-lisp
    ...
    (use-package general
      ...
      (start/leader-keys
        ...
        "m" '(:ignore t :wk "Javelin")
        "m a" '(javelin-add-file :wk "Javelin add file")
        "m d" '(javelin-delete :wk "Javelin Delete")
        "m c" '(javelin-clear :wk "Javelin clear")
        "m C" '(javelin-clear-all :wk "Javelin clear all")
        "m p" '(javelin-go-to-prev :wk "Javelin previous")
        "m n" '(javelin-go-to-next :wk "Javelin next"))
      ...
      (start/leader-keys
        ...
        "s g" '(jinx-languages :wk "Jinx choose language"))
