		...
		config = function()
			...
			vim.api.nvim_create_autocmd("LspAttach", {
				...
				callback = function(event)
					...
					map("<leader>ed", vim.lsp.buf.declaration, "Goto Declaration")

					-- Fuzzy find all the symbols in your current document.
					--  Symbols are things like variables, functions, types, etc.
					map("<leader>es", require("telescope.builtin").lsp_document_symbols, "Open Document Symbols")
					...
					map("<leader>et", require("telescope.builtin").lsp_type_definitions, "Goto Type Definition")
