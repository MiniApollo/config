...
local themes = {"powerarrow-dark" -- 1
}
...
globalkeys = mytable.join(
    ...
    awful.key({ modkey, "Shift"   }, "u", function () os.execute("systemctl reboot") end,
              {description = "Restart Computer", group = "awesome"}),

    awful.key({ modkey, "Shift"   }, "p", function () os.execute("systemctl poweroff") end,
              {description = "PowerOff Computer", group = "awesome"}),
    ...
    awful.key({ }, "XF86AudioMute",
        function ()
            os.execute(string.format("amixer -D pulse set Master 1+ toggle", beautiful.volume.togglechannel or beautiful.volume.channel))
            beautiful.volume.update()
        end,
    ...
    --FreeTube
    awful.key({ modkey }, "v", function () awful.spawn.with_shell("freetube") end,
              {description = "FreeTube", group = "launcher"}),
